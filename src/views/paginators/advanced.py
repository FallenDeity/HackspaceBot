...
class CategoryPaginatorSelect(discord.ui.Select[CategoryBasedPaginator[PageLike]]):
    ...
    async def callback(self, interaction: discord.Interaction) -> None:
        ...
        view.current_category = int(self.values[0])
        view.pages = view.categories[view.current_category].pages
        view.attachments = view.categories[view.current_category].attachments
        view.current_page = 0
